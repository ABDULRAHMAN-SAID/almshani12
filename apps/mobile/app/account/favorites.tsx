...
export default function Favorites() {
  ...
  return (
    <Screen onBack={() => safeBack(router)} title={t('account.favorites')} loading={q.isLoading} error={q.error} onRetry={() => q.refetch()} refreshing={q.isRefetching} onRefresh={() => q.refetch()}>
